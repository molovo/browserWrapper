...
( function ( $ ) {
  ...
  $.fn.browserWrapper = function ( options ) {
    ...
    var defaults = {
      ...
      favicon: '//browserwrapper.molovo.co.uk/img/favicon.png', //URL for favicon to appear on tab
    ...
    if ( defaults.os == 'detect' || defaults.browser == 'detect' || defaults.winVersion == 'detect' ) {
      ...
      BrowserDetect.init();
      if ( defaults.os == 'detect' ) {
        defaults.os = BrowserDetect.OS;
      };
      if ( defaults.browser == 'detect' ) {
        defaults.browser = BrowserDetect.browser;
      };
      if ( defaults.winVersion == 'detect' ) {
        defaults.winVersion = BrowserDetect.winVersion;
      };
    }
